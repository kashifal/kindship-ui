    ...
    <Fragment>
      <main>
        ...
        <div>
          ...
          <button onClick={() => setModal(true)} className="px-32 tracking-wide text-[19px] font-semibold text-center rounded-md text-white mx-auto py-4 inline-block bg-primary" >Learn More</button>
          </div>
