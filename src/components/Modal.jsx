                  ...
                  <div className=" py-6">
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        <Dialog.Title
                          as="h3"
                          className="text-[30px] font-semibold leading-6 text-gray-900"
                        >
                          Premium Supports
                        </Dialog.Title>
                        <div onClose={setIsModalOpen} className="mt-2">
                          <p className=" word-break text-[#8A8A8E] font-normal text-[21px] text-center">
                    ...
                    <div className="mt-5 sm:mt-6">
                      <button
                        type="button"
                        className="inline-flex w-full justify-center rounded-lg bg-primary px-3 py-2 text-[19px] font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                        onClick={() => setIndex(1)}
                      >
                        Next
                      </button>
                  ...
                  <div className="py-6">
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <div className="mt-2">
                          <p className=" text-[#8A8A8E] font-normal text-[21px] text-center">
                  ...
                  <div className="py-6">
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <div className="mt-2">
                          <p className=" text-[#8A8A8E] font-normal text-[21px] text-center">
                            Become the best advocate you can be! We've
                            crowdsourced the very best advice and support tools
                            from families kicking NDIS goals.
                          </p>
                        </div>
                      </div>
                    </div>
